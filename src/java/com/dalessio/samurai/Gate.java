...
public class Gate extends HttpServlet implements HttpSessionListener {
            ...
            if (operation != null && !operation.isEmpty()) {
                switch (operation.toLowerCase()) {
                    ...
                    case "create_user":
                        ...
                        break;
                    case "read_users":
                        readUsers(request, jsonResponse);
                        break;
                    case "update_user":
                    ...
                    case "change_password":
                        ...
                        break;
                    case "unlock_user":
                        unlockUser(request, jsonResponse);
                        break;

                    //CUSTOMERS
                    case "create_customer":
                        createCustomer(request, jsonResponse);
                        break;
                    case "read_customers":
                        readCustomers(request, jsonResponse);
                        break;
                    case "update_customer":
                        updateCustomer(request, jsonResponse);
                        break;
                    case "upload_logo":
                        uploadLogo(request, jsonResponse);
                        break;
                    case "check_vatcode":
                        checkVatCode(request, jsonResponse);
                        break;

                    //TRANSPORTERS
                    case "create_transporter":
                        createTransporter(request, jsonResponse);
                        break;
                    case "read_transporters":
                        readTransporters(request, jsonResponse);
                        break;
                    case "update_transporter":
                        updateTransporter(request, jsonResponse);
                        break;

                    //ORDERS
                    case "create_order":
                        createOrder(request, jsonResponse);
                        break;
                    case "read_orders":
                        readOrders(request, jsonResponse);
                        break;
                    case "update_order":
                        updateOrder(request, jsonResponse);
                        break;
                    case "get_machinary_models_by_customer_id":
                        getMachinaryModelsByCustomerId(request, jsonResponse);
                        break;
                    case "get_validity_machinary_model_by_order_code":
                        getValidityMachinaryModelByOrderCode(request, jsonResponse);
                        break;
                    case "get_suggested_orders":
                        getSuggestedOrders(request, jsonResponse);
                        break;
                    case "get_valid_code":
                        getValidCode(request, jsonResponse);
                        break;
                    case "adjurn_cover":
                        adjurnCover(request, jsonResponse);
                        break;

                    //TASKS
                    case "create_task":
                        createTask(request, jsonResponse);
                        break;
                    case "read_tasks":
                        readTasks(request, jsonResponse);
                        break;
                    case "update_task":
                        updateTask(request, jsonResponse);
                        break;
                    case "delete_task":
                        deleteTask(request, jsonResponse);
                        break;
                    case "create_task_attachment":
                        createTaskAttachment(request, jsonResponse);
                        break;
                    case "read_task_attachments":
                        readTaskAttachments(request, jsonResponse);
                        break;
                    case "delete_null_task_attachments":
                        deleteNullTaskAttachments(request, jsonResponse);
                        break;
                    case "delete_task_attachment":
                        deleteTaskAttachments(request, jsonResponse);
                        break;

                    //JOB TYPES
                    case "create_jobtype":
                        createJobType(request, jsonResponse);
                        break;
                    case "read_jobtypes":
                        readJobTypes(request, jsonResponse);
                        break;
                    case "update_jobtype":
                        updateJobType(request, jsonResponse);
                        break;

                    //TRANSLATION CENTERS
                    case "create_translations_center":
                        createTranslationCenter(request, jsonResponse);
                        break;
                    case "read_translations_centers":
                        readTranslationsCenters(request, jsonResponse);
                        break;
                    case "update_translations_center":
                        updateTranslationsCenter(request, jsonResponse);
                        break;

                    //JOB SUBTYPES
                    case "create_jobsubtype":
                        createJobSubtype(request, jsonResponse);
                        break;
                    case "read_jobsubtype":
                        readJobSubtypes(request, jsonResponse);
                        break;
                    case "update_jobsubtype":
                        updateJobSubtype(request, jsonResponse);
                        break;

                    //DELIVERY NOTES
                    case "create_delivery_note":
                        createDeliveryNote(request, jsonResponse);
                        break;
                    case "read_delivery_notes":
                        readDeliveryNotes(request, jsonResponse);
                        break;
                    case "read_delivery_note_rows":
                        readDeliveryNoteRows(request, jsonResponse);
                        break;
                    case "update_delivery_note":
                        updateDeliveryNote(request, jsonResponse);
                        break;
                    case "print_delivery_note":
                        printDeliveryNote(request, jsonResponse);
                        break;
                    ...
                    case "get_suggested_delivery_notes_rows":
                        getSuggestedDeliveryNotesRows(request, jsonResponse);
                        break;
                    case "create_invoice":
                        createInvoice(request, jsonResponse);
                        break;
                    case "read_invoices":
                    ...
                    case "read_invoice_rows":
                        ...
                        break;
                    case "update_invoice":
                        updateInvoice(request, jsonResponse);
                        break;
                    case "print_invoice":
                        printInvoice(request, jsonResponse);
                        break;
                    case "get_xml":
                        getXML(request, jsonResponse);
                        break;
                    case "update_invoice_date":
                        updateInvoiceDate(request, jsonResponse);
                        break;

                    //QUOTES
                    case "create_quote":
                        createQuote(request, jsonResponse);
                        break;
                    case "read_quotes":
                        readQuotes(request, jsonResponse);
                        break;
                    case "read_quote_rows":
                        readQuoteRows(request, jsonResponse);
                        break;
                    case "update_quote":
                        updateQuote(request, jsonResponse);
                        break;
                    case "create_quote_attachment":
                        createQuoteAttachment(request, jsonResponse);
                        break;
                    case "read_quote_attachments":
                        readQuoteAttachments(request, jsonResponse);
                        break;
                    case "delete_quote_attachment":
                        deleteQuoteAttachment(request, jsonResponse);
                        break;
                    case "print_quote":
                        printQuote(request, jsonResponse);
                        break;

                    //COMPLIANCE CERTIFICATE
                    case "create_certificate":
                        createCertificate(request, jsonResponse);
                        break;
                    case "read_certificate":
                        readCertificate(request, jsonResponse);
                        break;
                    case "update_certificate":
                        updateCertificate(request, jsonResponse);
                        break;

                    //CREDIT NOTES
                    case "create_credit_note":
                        createCreditNote(request, jsonResponse);
                        break;
                    case "read_credit_notes":
                        readCreditNotes(request, jsonResponse);
                        break;
                    case "read_credit_note_rows":
                        readCreditNoteRows(request, jsonResponse);
                        break;
                    case "update_credit_note":
                        updateCreditNote(request, jsonResponse);
                        break;
                    case "print_credit_note":
                        printCreditNote(request, jsonResponse);
                        break;
                    case "get_credit_note_xml":
                        getCreditNoteXML(request, jsonResponse);
                        break;

                    //Amount Schedule Dates
                    case "fill_amount_schedule_dates":
                        fillAmountScheduleDates(request, jsonResponse);
                        break;
                    case "read_amount_schedule_dates":
                        readAmountScheduleDates(request, jsonResponse);
                        break;
    ...
    private void authenticate(HttpServletRequest request, JsonObject jsonResponse) throws SQLException, ClassNotFoundException {
        ...
        if (user_id > 0L && active) {
            ...
            /**
             * now in the Json response we have the session id that allows to
             * get the sesion object. furthermore we have the user_id so
             * whenever we want, we can verify if the current session has been
             * created by the right user. If the session hasn't got the user_id
             * attribute that means the user is not authenticated.
             */
    ...
    private void updateUser(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid user_id format");
            }
            ...
            try {
                hourlyCost = Double.parseDouble(request.getParameter("hourlyCost"));
    ...
    private void changePassword(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            Long user_id = null;
            try {
                user_id = Long.parseLong(session.getAttribute("user_id").toString());
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid user_id format");
            }
    ...
    private void updateCustomer(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid customer_id format");
            }
            String vatCode = request.getParameter("vatCode");
            String fiscalCode = request.getParameter("fiscalCode");
            String denomination = request.getParameter("denomination");
    ...
    private void readJobTypes(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                jobType_id = Long.parseLong(request.getParameter("jobType_id"));
            } catch (NumberFormatException Nex) {
            }
    ...
    private void readJobSubtypes(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                jobSubtype_id = Long.parseLong(request.getParameter("jobSubtype_id"));
            } catch (NumberFormatException Nex) {
            }
    ...
    private void updateJobSubtype(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid jobSubtype_id format");
            }
            String name = request.getParameter("name");
            String description = request.getParameter("description");
    ...
    private void readTranslationsCenters(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                translations_center_id = Long.parseLong(request.getParameter("translations_center_id"));
            } catch (NumberFormatException Nex) {
            }
    ...
    private void updateTranslationsCenter(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid translarions_center_id format");
            }
            String denomination = request.getParameter("denomination");
            String notes = request.getParameter("notes");
    ...
    private void readTransporters(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                transporter_id = Long.parseLong(request.getParameter("transporter_id"));
            } catch (NumberFormatException Nex) {
            }
            String vatCodeHint = request.getParameter("vatCodeHint");
            String fiscalCodeHint = request.getParameter("fiscalCodeHint");
    ...
    private void updateTransporter(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid transporter_id format");
            }
            String vatCode = request.getParameter("vatCode");
            String fiscalCode = request.getParameter("fiscalCode");
            String denomination = request.getParameter("denomination");
    ...
    private void readOrders(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                creator_id = Long.parseLong(request.getParameter("creator_id"));
            } catch (NumberFormatException Nex) {
            }
            ...
            try {
                availability_id = Long.parseLong(request.getParameter("availability_id"));
            } catch (NumberFormatException Nex) {
            }
    ...
    /**
     * Checks in DB id has been inserted a new logo for the customer. If yes
     * produces a new pdf file of the order cover having the new logo
     *
     * @param request
     * @param jsonResponse
     * @throws SQLException
    ...
    private void updateOrder(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid order_id format");
            }
            ...
            if (request.getParameter("completionState_id") != null) {
                try {
                    completionState_id = Long.parseLong(request.getParameter("completionState_id"));
                } catch (NumberFormatException Nex) {
                    jsonResponse.addProperty("message", "invalid completionState_id format");
                }
            }
            ...
            if (request.getParameter("code") != null) {
                try {
                    ...
                    jsonResponse.addProperty("message", "invalid code format");
                }
            }
            ...
            if (request.getParameter("notSuggest") != null) {
                try {
                    notSuggest = Boolean.parseBoolean(request.getParameter("notSuggest"));
                } catch (NumberFormatException Nex) {
                    jsonResponse.addProperty("message", "invalid notSuggest format");
                }
            }
    ...
    private void createTask(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid hours format");
            }
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid translations_center_id format");
            }

            Double translationPrice = null;
            try {
                translationPrice = Double.parseDouble(request.getParameter("translationPrice"));
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid translationPrice format");
            }

            Double translationCost = null;
            try {
                translationCost = Double.parseDouble(request.getParameter("translationCost"));
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid translationCost format");
            }
            ...
            try {
                externalJobsHours = Double.parseDouble(request.getParameter("externalJobsHours"));
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid externalJobsHours format");
            }

            Double externalJobsCost = null;
            try {
                externalJobsCost = Double.parseDouble(request.getParameter("externalJobsCost"));
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid externalJobsCost format");
            }
            ...
            try {
                variouseMaterialCost = Double.parseDouble(request.getParameter("variouseMaterialCost"));
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid variouseMaterialCost format");
            }

            Integer transfertKms = null;
            try {
                transfertKms = Integer.parseInt(request.getParameter("transfertKms"));
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid transfertKms format");
            }

            Double transfertCost = null;
            try {
                transfertCost = Double.parseDouble(request.getParameter("transfertCost"));
            } catch (NumberFormatException Nex) {
                jsonResponse.addProperty("message", "invalid transfertCost format");
            }
    ...
    private void readTasks(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                operator_id = Long.parseLong(request.getParameter("operator_id"));
            } catch (NumberFormatException Nex) {
            }
            ...
            try {
                order_creator_id = Long.parseLong(request.getParameter("order_creator_id"));
            } catch (NumberFormatException Nex) {
            }
    ...
    private void updateTask(HttpServletRequest request, JsonObject jsonResponse) throws SQLException, Exception {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                throw new Exception("missing or incorrect task id");
            }
            ...
            try {
                ...
                throw new Exception("missing or incorrect jobSubtype_id ");
            }
    ...
    private void deleteTask(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            try {
                ...
                jsonResponse.addProperty("message", "invalid task_id format");
            }
    ...
    private void readCertificate(HttpServletRequest request, JsonObject jsonResponse) throws SQLException {
        ...
        if (session != null && session.getAttribute("user_id") != null) {
            ...
            Long cert_id = null;
            try {
                cert_id = Long.parseLong(request.getParameter("cert_id"));
            } catch (NumberFormatException Nex) {
            }
    ...
    /**
     * To be called once befor deploying in production the version it populates
     * the amount schedule DB table with all invoices data at the moment of the
