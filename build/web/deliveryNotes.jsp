...
<%}else
{
  ...
  %>
    ...
    <html>
        ...
        <body onload="app.filterDeliveryNotes();">
            
            <div class="Header">
                <span class="SWName">Workline 2.0</span><span class="PageTitle"> Documenti di Trasporto </span>
            </div>
           ...
           <div class="Dropdown_registry">
            ...
            <div class="Filters">
                ...
                <div id="refresh" class="Button" onclick="app.filterDeliveryNotes();"><i  id="searchIcon" class="fa fa-search" aria-hidden="true"></i>RICERCA</div>
            </div>     
        ...
        <template id="deliveryNoteTableRow">
            <tr class="DeliveryNoteTableRow">
                <td class="DeliveryNoteNumber"></td>
