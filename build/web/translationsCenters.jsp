...
<%}else
{
  ...
  %>
    ...
    <html>
        ...
        <body onload="app.getTranslationsCentersPage();">
            <div class="Header">
                <span class="SWName">Workline 2.0</span><span class="PageTitle">Centri Traduzione</span>
            </div>
           ...
           <div class="Dropdown_registry">
            ...
            <div class="Filters">
                <span id="newTranslationCenterButton" class="Button Operation" onclick="document.querySelector('.Modal_screen').classList.add('Visible');">NUOVO CENTRO</span>
            </div>
            ...
            <div class="Modal_screen">
                <div class="New_record">
                    <input id='new_translations_center_denomination_input' placeholder=" NOME CENTRO "><br>
                    <span type='button' class='Button Accept' onclick="app.createNewTranslationsCenter();">AGGIUNGI</span>
        ...
        <template id="translations_center_template">
            <tr id="translations_center_row">
