...
<%}else
{
  ...
  %>
    ...
    <html>
        ...
        <body onload="app.getTranslationsCenterDetailsPage(<%=request.getParameter("translations_center_id")%>);">
            <div class="Header">
                <span class="SWName">Workline 2.0</span><span class="PageTitle"> Centro Traduzioni </span>
            </div>
            ...
            <div class="Content">
                ...
                <span id="updateTranslationsCenterButton" class="Button Operation Update" onclick="app.translationsCenterUpdated('<%=request.getParameter("translations_center_id")%>');">CONFERMA MODIFICHE</span>
            </div>
        ...
        <template id="translations_center_details_template">
            <!--table class="Details_table"-->
                <tr class="Details_row">
                    <th id="denomination" class="Detail_header">NOME CENTRO</th><td><input id='denomination_input' onchange="app.translationsCenterDetailsChanged('#denomination_input');"></td>
                </tr>
                <tr class="Details_row">
                    <th id="notes" class="Detail_header">NOTE</th><td><input id='notes_input' onchange="app.translationsCenterDetailsChanged('#notes_input');"></td>
                </tr>
            <!--/table-->
        </template>
        <script src="/Samurai/dbi.js?<%=timestamp%>"></script>
        <script src="/Samurai/translationsCenters.js?<%=timestamp%>"></script>
