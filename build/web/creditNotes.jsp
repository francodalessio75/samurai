...
<html>
    ...
    <body onload="app.filterCreditNotes();">

        <div class="loader" id="loader"></div>
        <div id="modal" class="modal"></div>

        <div class="Header">
            <span class="SWName">Workline 2.0</span><span class="PageTitle"> Note di Accredito </span>
        </div>
        ...
        <div class="Filters">
            ...
            <div id="refresh" class="Button" onclick="app.filterCreditNotes();"><i  id="searchIcon" class="fa fa-search" aria-hidden="true"></i>RICERCA</div>
        </div> 
    ...
    <template id="creditNoteTableRow">
        <tr class="CreditNoteTableRow">
            <td class="CreditNoteNumber"></td>
            <td class="CreditNoteDate"></td>
