...
<html>
    ...
    <body onload="app.getJobTypeDetailsPage(<%=request.getParameter("jobType_id")%>);">

        <div class="loader" id="loader"></div>
        <div id="modal" class="modal"></div>

        <div class="Header">
            <span class="SWName">Workline 2.0</span><span class="PageTitle"> Tipo di Lavoro </span>
        </div>
        ...
        <div class="Content">
            ...
            <div id="updateJobTypeButton" class="Button Operation Update" onclick="app.jobTypeUpdated(<%=request.getParameter("jobType_id")%>);">CONFERMA MODIFICHE</div>
        </div>
    ...
    <template id="jobType_details_template">
        <!--table class="Details_table"-->
        <tr class="Details_row">
            <th id="name" class="Detail_header">NOME</th><td><input id='name_input' onchange="app.jobTypeDetailsChanged('#name_input');"></td>
        </tr>
        <tr class="Details_row">
            <th id="description" class="Detail_header">DESCRIZIONE</th><td><input id='description_input' onchange="app.jobTypeDetailsChanged('#description_input');"></td>
        </tr>
        <!--/table-->
    </template>
    <script src="/Samurai/dbi.js?<%=timestamp%>"></script>
    <script src="/Samurai/jobTypes.js?<%=timestamp%>"></script>
