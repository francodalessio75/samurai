...
<html>
    ...
    <body onload="document.getElementById('username').focus();">
        ...
        <div id="credentials">
            ...
            <input id="username" type="text" placeholder="username" onkeydown="app.username_onKeyDown(event);" value="<%=Config.DEBUG ? "paola" : ""%>"><br>
            <input id="password" type="password" placeholder="password" onkeydown="app.password_onKeyDown(event);" value="<%=Config.DEBUG ? "giulia" : ""%>">
        </div>
