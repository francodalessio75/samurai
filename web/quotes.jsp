...
<%}else
{
  ...
  <html>
        ...
        <body onload="app.filterQuotes();">
            
            <div class="Header">
                <span class="SWName">Workline 2.0</span><span class="PageTitle"> Preventivi </span>
            </div>
           ...
           <div class="Dropdown_registry">
            ...
            <div class="Filters">
                ...
                <div id="refresh" class="Button" onclick="app.filterQuotes();"><i  id="searchIcon" class="fa fa-search" aria-hidden="true"></i>RICERCA</div>
            </div> 
            ...
            <div class="Content WithFilter">
                <table class="Table" >
                    ...
                    <col width="10%">
                    <col width="70%">
<!--                    <col width="10%"> Eliminated the 11th July 2019 becouse the total not always is correct, eg. when different versions of the same product are offered  -->
                    <col width="10%">
                    <thead>
                        <th class="ThList">NUMERO</th>
                        <th class="ThList">DATA</th>
                        <th class="ThList">CLIENTE</th>
<!--                        <th class="ThList">IMPORTO</th> Eliminated the 11th July 2019 becouse the total not always is correct, eg. when different versions of the same product are offered  -->
        ...
        <template id="quoteTableRow">
            <tr class="QuoteTableRow">
                <td class="QuoteNumber"></td>
                <td class="QuoteDate"></td>
                <td class="Customer"></td>
<!--                <td class="Amount"></td> Eliminated the 11th July 2019 becouse the total not always is correct, eg. when different versions of the same product are offered  -->
                <td class="Pdf">PDF</td>
            </tr>
        </template>
