...
<%}else
{
  ...
  %>
    ...
    <html>
        ...
        <body onload="app.getJobTypesPage();">
            
            <div class="Header">
                <span class="SWName">Workline 2.0</span><span class="PageTitle"> Tipi di Lavoro </span>
            </div>
           ...
           <div class="Dropdown_registry">
            ...
            <div class="Filters">
                ...
                <span id="newJobTypeButton" class="Button Operation" onclick="document.querySelector('.Modal_screen').classList.add('Visible');"> NUOVO TIPO LAVORO</span>
            ...
            <div class="Modal_screen">
                <div class="New_record">
                    <input id='new_jobType_name_input' placeholder="NOME TIPO LAVORO"><br>
                    <span type='button' class='Button Accept' onclick="app.createNewJobType();">AGGIUNGI</span>
