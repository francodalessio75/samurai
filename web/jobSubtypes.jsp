...
<%}else
{
  ...
  %>
    ...
    <html>
        ...
        <body onload="app.getJobSubtypesPage();">
            
            <div class="Header">
                <span class="SWName">Workline 2.0</span><span class="PageTitle"> Tipi di Lavorazione </span>
            </div>
           ...
           <div class="Dropdown_registry">
            ...
            <div class="Filters">
                ...
                <span id="newJobSubtypeButton" class="Button Operation" onclick="document.querySelector('.Modal_screen').classList.add('Visible');">NUOVO TIPO LAVORAZIONE</span>
            ...
            <div class="Modal_screen">
                <div class="New_record">
                    <input id='new_jobSubtype_name_input' placeholder="NOME TIPO LAVORAZIONE"><br>
                    <span type='button' class='Button Accept' onclick="app.createNewJobSubtype();">AGGIUNGI</span>
        ...
        <template id="jobSubtype_template">
            <tr id="jobSubtype_row">
                <td id="name"></td>
            </tr>
        </template>  
